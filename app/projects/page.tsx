      ...
      <section className="max-w-5xl mx-auto text-center space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#2f1b3a] p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            {/* ecommerce */}
            <div className="bg-[#2f1b3a] p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
            <h2 className="text-xl font-semibold mb-2">Travel Accessories</h2>
            <p className="text-sm text-gray-300 mb-4">
              An ecommerce website built using **HTML**,**CSS**,**JavaScript**,**Laravel**,
              **MYSQL** for providing a fully functional e-commerce platform for purchasing travel accessories.
            </p>
            <a
              href="https://github.com/Maimuna-Chowdhury/Website_Travel_Accessories"
              className="text-blue-400 hover:text-blue-500 transition duration-200"
            >
              View Project
            </a>
